// This sketch is using the code of InterlinkKnight from this tutorial: https://www.youtube.com/watch?v=u2uJMJWsfsg
// All credit goes to the original author for sharing his knowledge. 


// The interrupt-enabled digital pin the KY-003 Hall sensor is connected to.
// Read more about the sensor: https://arduinomodules.info/ky-003-hall-magnetic-sensor-module/
// Read more about interrupts: https://www.arduino.cc/reference/en/language/functions/external-interrupts/attachinterrupt/
int sensorPin = 2;
...
int counter = 0;  // The number of events measured. (Useful to detect missing or duplicate events when debugging.)
...
void setup()
{
  ...
  attachInterrupt(digitalPinToInterrupt(sensorPin), Pulse_Event, CHANGE);
